...
Then I grouped the initial codes into broader categories and identified relationships between them to form themes. A few attempts were made to refine the list and create properties for each theme.
