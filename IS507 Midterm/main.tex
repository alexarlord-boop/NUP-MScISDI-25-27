...
\\
Recommended Strategy: Dual-Track Approach with Incremental Emphasis (70/30 split).
...
\begin{center}
\textbf{Table 1: Technology Positioning Summary for UrbanMove}
\end{center}
...
Discuss how UrbanMove should evaluate and prioritise the four streams of Project Nexus.

\subsubsection{Selection criteria}
Which selection criteria (e.g., strategic alignment, risk, capability, ROI) are most appropriate?
